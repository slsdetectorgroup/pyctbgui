...
def test_parse_sample_file():
    ...
    true_names = [
        ...
        'DGS23', 'DGS31',
        'DGS22', 'DGS30', 'DGS21', 'DGS29', 'DGS20', 'DGS28', 'DGS19', 'DGS27', 'DGS18', 'DGS26', 'DGS17', 'DGS25',
        'DGS16',
        'DGS24'
    ]

    true_plot = [None, True, None, True, None, True, None, True, None, None, None, None, None, None, None, None, None,
                 None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None,
                 None, None, None, None, None, None, None, None, None, None, None, None, None, None, True, True, True,
